    ...
    return (
        <div className={`w-full h-dvh flex flex-col bg-white roboto-regular`}>
            <nav className={`text-3xl flex justify-center relative py-4 w-full bg-orange-500 text-white`}>
                <p className='font-light'>Karta</p>
                <svg onClick={() => router.push('/')} className='w-10 rotate-180 absolute left-0 top-[calc(50%-20px)]' viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <svg onClick={() => router.push('/createsector')} viewBox="0 0 24 24" className="w-10 absolute right-0 top-[calc(50%-20px)]" fill="white">
